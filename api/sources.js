const sources=[
 ...
 {id:'bestmart360',name:'優品360',type:'official-promotion',status:'promo-only',url:'https://www.bestmart360.com/',promoUrl:'https://www.bestmart360.com/promo',note:'已接官方香港推廣頁；未有穩定逐件結構化價格 feed 前，不會假扮即時格價。'},
...
export default function handler(req,res){res.status(200).json({updatedAt:new Date().toISOString(),sources,livePriceRetailers:['惠康','百佳','Market Place','屈臣氏','萬寧','AEON','大昌食品','莎莎','龍豐'],promoOnlyRetailers:['優品360','759阿信屋'],rule:'未有可核實逐件價格時，不把推廣頁當成即時貨架價。'});}

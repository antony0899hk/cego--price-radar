const sources=[
 ...
 {id:'wellcome',name:'惠康',type:'official-promotion',status:'live',url:'https://www.wellcome.com.hk/',promoUrl:'https://www.wellcome.com.hk/zh-hant/wellcome/d/UYotKNFg7BGJ.html',note:'官方推廣／本週廣告；只在可核實時用作優惠證據。'},
 {id:'parknshop',name:'百佳',type:'official-retailer',status:'live',url:'https://www.parknshop.com/',note:'價格比較目前以消委會公開資料為主。'},
 {id:'hksb-wellcome',name:'惠康每週優惠文字版',type:'secondary-structured-promotion',status:'live',url:'https://iac-tdls.hksb.org.hk/web_info_detail.php?content=supermarket_wellcome',note:'香港盲人輔導會公開文字轉錄；用作門市優惠結構化補漏，可信度低於零售商官方來源。'},
 {id:'hksb-parknshop',name:'百佳每週優惠文字版',type:'secondary-structured-promotion',status:'live',url:'https://iac-tdls.hksb.org.hk/web_info_detail.php?content=supermarket_parknshop',note:'香港盲人輔導會公開文字轉錄；用作門市優惠結構化補漏，可信度低於零售商官方來源。'},
 {id:'media-promotion',name:'公開優惠報道',type:'media-promotion-evidence',status:'supplemental',note:'只採用有日期、優惠條件及可追溯來源的公開報道作交叉核對；不取代官方來源，不當成指定分店即時貨架價。'},
